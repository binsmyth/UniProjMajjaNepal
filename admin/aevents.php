		...
		<div id="nav_bar" class="style">
			...
			<fieldset>
				...
				<legend>Create Event</legend>
						<form id="event" name="form1" method="post" action="aevents_script.php" enctype="multipart/form-data">
				
				
		<label for ="ename">Event Name:</label><input type="text" name="ename" id="ename"><br>
		<label for="eadd">Event Address:</label><input type="text" name="eadd" id="eadd"><br>
		<label for="edate">Event Date:</label><input type="text" name="edate" id="edate" value="year-Month-Date"><br>
		<label for="eprice">Event Price:</label><input type="text" name="eprice" id="eprice"><br>
		<label for="upload">Event Image:</label><input type="file" name="upload"><br>
		
		<label for="cid">Category Id</label>
		<select name="cid">
			<option>1 - Sports</option>
			<option>2 - DJ Parties</option>
			<option>3 - Concert</option>
			<option>4 - Comedy Show</option>
			<option>5 - Movie Mania</option>
		</select>
		<br>
