...
<div id="wrapper">
	...
	<div id="right-content">
		...
		$sql="select * from address where user_id=$user";
		$query=mysql_query($sql);
		echo "<fieldset><legend>My Address</legend>";
		echo "<form name=\"address\" action=\"address_script.php\" method=\"POST\">";
		while($row=mysql_fetch_array($query))
		{
			
			?>
			
				<label for="saddress">Street:</label><input type="text" name="saddress" value="<?php echo $row['faddress'];?>"><br>
			
				<label for="suburb">Suburb:</label><input type="text" name="suburb" value="<?php echo $row['suburb'];?>"><br>
				<label for="postcode">Post Code:</label><input type="text" name="postcode" value="<?php echo $row['post_code'];?>"><br>
				<label for="state">State:</label><input type="text" name="state" value="<?php echo $row['state'];?>"><br>
