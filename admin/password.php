	...
	<div id="right-content">
		<div id="nav_bar" class="style">
			...
			<fieldset><legend>Password</legend>
				<form name="password_change" method="POST" action="form_password_script.php">
				
				<label for="old_pass">Old Password:</label><input type="password" name="old_pass" ><br>
			
				<label for="new_pass">New Password:</label><input type="password" name="new_pass" ><br>
				<label for="new_pass1">New Password:</label><input type="password" name="new_pass1"><br>
