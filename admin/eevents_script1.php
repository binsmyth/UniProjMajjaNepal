...
<div id="wrapper">
	...
	<div id="right-content">
		...
		if($eadd=="" or $edate=="" or $eprice=="" or $ename=="")
		{
			echo "<br><br>All fields are required.";
			echo"<br><a href='eevents_script.php'>Go Back</a>";
		}
		else
		{
			
		
			$sql="update event_types set event_name='$ename', event_price='$eprice', event_date='$edate', event_address='$eadd'  where event_name='$ename'";
			$query=mysql_query($sql);
				echo "<br><br>Update has been Successfull!!!";
