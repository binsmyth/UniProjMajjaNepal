...
<div id="wrapper">
	...
	<div id="right-content">
		...
		<?php
		$search=$_POST['search'];
		$sql="select * from users where user_name='$search'";
		...
		if($count==1)
		{
			...
			{
				echo "Your Search Result found following Results<br><br>";
				echo "First Name: ".$row['first_name'];
				echo "<br>Last Name: ".$row['last_name'];
				echo "<br> Email: ".$row['user_name'];
			}
			...
			{
			echo "Search result has not found..Please search it again!!!";
		}
