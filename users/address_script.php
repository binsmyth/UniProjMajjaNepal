...
<div id="wrapper">
	...
	<div id="right-content">
		...
		if($sad=="" or $suburb=="" or $postc=="" or $state=="")
		{
			echo "All fields are required.";
			echo"<br><a href='address.php'>Go Back</a>";
		}
		else
		{
			
		
			$sql="update address set faddress='$sad', suburb='$suburb', state='$state', post_code='$postc'  where user_id='$id'";
			$query=mysql_query($sql);
				echo "<br><br>Update has been Successfull!!!<br><br>";
				echo "Now, You have following address:<br>";
				echo "<strong>$sad".",";
				echo "<br>$suburb".","." $postc";
				echo "<br>$state</strong>";
		}
